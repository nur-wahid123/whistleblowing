...
export default function MessageDetailDone({ id, data }) {
    // console.log(data);
    ...
    return (
        <div>
            ...
            <div
                ...
                className="w-20 underline link link-hover link-primary cursor-pointer overflow-hidden whitespace-nowrap text-ellipsis"
            >
                Lihat Detail
            </div>
