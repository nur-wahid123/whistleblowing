...
export const downloadMultiplePDF = async (data, fileName) => {
    const doc = (
        <Document>
            {data.map((data, i) => (
                <Page style={styles.page}>
                    ...
                    >
                        <Text style={{ fontWeight: "bold" }}>Status Pesan : {data.status}</Text>
...
export const downloadSinglePDF = async (data, fileName) => {
    const doc = (
        <Document>
            <Page style={styles.page}>
                <Text style={styles.title}>Laporan Keluhan</Text>
                ...
                >
                    ...
                    {(data.status == "diterima" ||
                        data.status == "ditolak") && (
                        <View>
                            <Text>Catatan Dari PIC : {data.catatan_admin}</Text>
                            {data.gambar_admin != null && (
                                <View>
                                    <Text>Bukti Gambar PIC :</Text>
                                    <Image
                                        src={`/storage/image/pic/${data.gambar_admin}`}
                                    />
                                </View>
